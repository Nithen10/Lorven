...
export function HoverRevealButton({ label = "Our Work", size = "sm" }: HoverRevealButtonProps) {
  ...
  return (
    <div
      className={`group relative cursor-pointer ${sizing} rounded-full overflow-hidden text-black text-center font-semibold`}
    ...
    >
      ...
      <div className="flex gap-2 text-white bg-black z-10 items-center absolute left-0 top-0 h-full w-full justify-center translate-y-12 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300 rounded-full group-hover:rounded-none">
